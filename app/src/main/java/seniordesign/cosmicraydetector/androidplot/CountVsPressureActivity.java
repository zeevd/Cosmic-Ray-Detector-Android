 ...
 */
public class CountVsPressureActivity extends ActionBarActivity {
    ///LOGGING TAG///
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        ArrayList<Number> pressure = new ArrayList<Number>();
        ...
        for (Long key : keySet){
            ...
            pressure.add(sensorData.getPressure());

        }


        // create our series from our array of nums:
        XYSeries series2 = new SimpleXYSeries(pressure,rayCount,"Cosmic ray count");
        ...
        mySimpleXYPlot.setDomainStep(XYStepMode.INCREMENT_BY_PIXELS, pressure.size());

        // customize our domain/range labels
        mySimpleXYPlot.setDomainLabel("Pressure");
